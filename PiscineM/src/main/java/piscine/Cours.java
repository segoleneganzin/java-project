...
//	private List<Code> lesCodes = new ArrayList<Code>();	//lien tables d'association "participe"
	...
	public Cours(String intitule, LocalDateTime horaireDebut, LocalDateTime horaireFin, int nombrePlacesInitiales,
			Employe employe, Piscine piscine) {
		super();
	...
	public Cours(int idCours, String intitule, LocalDateTime horaireDebut, LocalDateTime horaireFin,
			int nombrePlacesInitiales, Employe employe, Piscine piscine) {
		super();
...
//	}
	...
	public String toString() {
		return "Cours [idCours=" + idCours + ", intitule=" + intitule + ", date : " + toStringDate() + ", horaireDebut="
				+ toStringHoraireDebut() + ", horaireFin=" + toStringHoraireFin() + ", nombrePlacesInitiales="
				+ nombrePlacesInitiales + ", placesRestantes=" + this.getPlacesRestantes() + ", employe=" + employe
				+ "]";
	}
