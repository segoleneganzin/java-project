...
public class PaiementController extends GeneralController{
	...
	@FXML private Pane paiementPane;
	@FXML private Pane pinCodePane;
			...
			if(event.getSource() == valider && pincode.getLength()==4) {
				try {
					...
					if (modalite.equals("solo") || modalite.equals("duo")) {
						...
						Utilisation utilisation = new Utilisation(unCours.getHoraireDebut(), nouveauCode, unCours.getPiscine());
