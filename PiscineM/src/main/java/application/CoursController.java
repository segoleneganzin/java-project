...
public class CoursController extends GeneralController {
	...
	@FXML
	private Button afficherCours;
	@FXML
	private Label intituleCours;
	@FXML
	private Label dateCours;
	@FXML
	private Label horaireDebut;
	@FXML
	...
	public void afficherCours(ActionEvent event) {
		...
		heureDebut
				.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().toStringHoraireDebut()));
