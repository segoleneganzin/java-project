...
public class AboController extends GeneralController {
	...
	@FXML
	private Pane descriptionAboSolo;
	@FXML
	private Pane descriptionAboDuo;
	@FXML
	private Label nbEntreeSolo;
	@FXML
	private Label validiteSolo;
	@FXML
	private Label tarifSolo;
	@FXML
	private Label nbEntreeDuo;
	@FXML
	private Label validiteDuo;
	@FXML
	private Label tarifDuo;
	@FXML
	private Button voirSolo;
	@FXML
	private Button achatSolo;
	@FXML
	private Button voirDuo;
	@FXML
	private Button achatDuo;
	@FXML
