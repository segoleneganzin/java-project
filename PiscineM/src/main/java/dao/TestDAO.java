...
public class TestDAO {
	...
	public static void main(String[] args) {
		...
		////////////////////////////////////////////////////////// TEST COURS
		// Creation cours :
		// Cours cours = new Cours("Aqua", null, null, 10, 10,
		////////////////////////////////////////////////////////// EmployeDAO.getInstance().read(1),
		////////////////////////////////////////////////////////// PiscineDAO.getInstance().read(2));
		// cours.setHoraireDebut(LocalDateTime.of(2023, Month.SEPTEMBER, 29, 19, 30,
		////////////////////////////////////////////////////////// 40));
...
//					CoursDAO.getInstance().delete(cours);
		...
		////////////////////////////////////////////////////////// TEST PISCINE
		// Creation piscine :
		// Piscine p1 = new Piscine("p10", "9h00", "20h00",
		////////////////////////////////////////////////////////// AdresseDAO.getInstance().read(1));
		...
		// lesPiscines.add(pis);
		// Employe employe = new Employe("Test", "Roger", "Accueil", null,
		////////////////////////////////////////////////////////// AdresseDAO.getInstance().read(1),
		////////////////////////////////////////////////////////// lesPiscines);
...
//					System.out.println(utilisation);
		...
		////////////////////////////////////////////////////////// Administrateur(EmployeDAO.getInstance().read(4),
		////////////////////////////////////////////////////////// "Test", "TestMdp");
